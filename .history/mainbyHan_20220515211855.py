...
def random_vs_pestosbnegamax(minimax_chess_color):
    pygame.init()
    screen = pygame.display.set_mode((WIDTH, HEIGHT))
    board = chess.Board()

    player1 = pestosmimax.pestos(minimax_chess_color)
    player2 = minimax_agent.MinimaxPlayer()
    draw_board(screen)
    load_image()
    black_win = pygame.transform.scale(
        pygame.image.load("images/bK.png"), (256, 256))
