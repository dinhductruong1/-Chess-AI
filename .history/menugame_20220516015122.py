...
from mainbyHan import human_chess_color, get_level, 
...
def set_chess_color(selected: Tuple, value: Any):
    if value == 0:
        mainbyHan.human_chess_color = True
    else:
        mainbyHan.human_chess_color = False


def set_bot1(selected: Tuple, value: Any):
    mainbyHan.bot1 = mainbyHan.get_leval(value)
